...
uint256 hashGenesisBlock("0x00000000563ff7cc3146dd1176d921dcfe83199c388fc412fe1461bd98ff3d24");
...
const string strMessageMagic = "sdfcoin Signed Message:\n";
...
{
    int64 nSubsidy = 123 * COIN;

    // Subsidy is cut in half every 3000 blocks, which will occur approximately every 4 years
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000563ff7cc3146dd1176d921dcfe83199c388fc412fe1461bd98ff3d24");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1431274587;
        block.nBits    = 486604799;
        block.nNonce   = 1434150826;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("sdfcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("sdfcoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running sdfcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("sdfcoinMiner terminated\n");
        throw;
    }
}
